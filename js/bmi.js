    ...
    function updateMainList(items){
        ...
        for(let i=0; i<itemsLen; i++){
            str += '<div class="flex flex-row justify-between bg-white shadow w-full xl:w-1/2 xl:h-[50px] xl:mx-[25%] mb-5 relative"><div class=" '+items[i].listBgColor+' shadow-md"><span class="invisible">1</span></div><div class="py-3 absolute left-[40px]"><span class="text-[20px]">'+items[i].listBMI+'</span></div><div class="p-3 xl:absolute xl:left-[150px] ml-5"><span class="text-[12px]">BMI</span><span class="xl:text-[20px]">'+items[i].listBmiVal+'</span></div><div class="p-3 ml-5 xl:absolute xl:left-[300px]"><span class="text-[12px]">weight</span><span class="xl:text-[20px]">'+items[i].listweight+'</span><span class="xl:text-[20px]">kg</span></div><div class="p-3 xl:absolute xl:left-[500px]"><span class="text-[12px]">height</span><span class="xl:text-[20px]">'+items[i].listheight+'</span><span class="xl:text-[20px]">cm</span></div><div class="p-3 xl:absolute xl:left-[680px] xl:bottom-0"><span class="text-[12px]">'+items[i].listTime+'</span></div></div>'
        }
